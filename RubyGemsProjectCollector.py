...
while count < len(letters):
    ...
    #This while loop iterates through all the pages grabbing the projects of the current letter
    while page <= pages:
        ...
        for row in soup.findAll('a', { "class" : "gems__gem" }):
            ...
            if projectName != 'cookbooks':
                ...
                try:
                    print("inserting",projectName,"into Elon")
                ...
                try:
                    print("inserting",projectName,"into Syr")
